class Tree extends GameObject {
	...
	// override
	public update(): void {
		this.spritesheetBounds.x += this.imageShifts.speed * this.imageShifts.direction;
		this.spritesheetBounds.y += this.imageShifts.speed/2 * this.imageShifts.direction;
